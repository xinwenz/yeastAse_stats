setwd("~/cloud/project/hpc_pre/calh_notail/")
load("hpc_need.RData") # likelihood functions,paraGetB/BB,expi,cali,expi_Ct,cali_Ct  
require("foreach")
require("iterators")
library("bbmle")

#myargs <- c(2850, 7, 15, 18, 19, 16, 3, 4, 10, 1, 12, 11, 8, 9, 14, 17, 5, 20, 6 ,2 ,27 ,35 ,38 ,39 ,36, 23, 24, 30, 21, 32, 31 ,28 ,29, 34 ,37, 25, 40, 26, 22)
myargs <- c(0085 ,10 ,30) 
#myargs <- c(0153, 19, 10, 39, 30)
num <- myargs[1]
#num <- "test_allsame"
...
orig <- calh_notail[3500:3530,]
orig_Ct <- calh_notail_Ct
f <- "calh_notail_liko"
#######################################################
