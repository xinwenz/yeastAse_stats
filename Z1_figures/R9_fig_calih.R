...
for(i in 1:2850) {
    mydataName <- paste0("~/cloud/project/R9_calih_RM4A_gene/calih_RM4Agene_",formatC(i,width=4,flag="0"),".RData")
    load(mydataName)
}

df_calih_RM4A <- fpo_format(nm="calih_RM4Agene_",each_nr = 150,nr = 19, nGenes= 4771,nbit=4)
...
ggplot(df_calih_RM4A, aes(x=Used_replicates, y=fp_rate, shape=type)) + 
